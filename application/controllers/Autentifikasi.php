...
'required', [
        ...
        //membuat rule untuk inputan email agar tidak boleh kosong, tidak ada spasi, format email harus valid dan email belum pernah dipakai sama user lain dengan membuat pesan error dengan bahasa sendiri yaitu:

//jika format email tidak benar maka pesannya 'Email Tidak Benar!!'. 
//jika email belum diisi, maka pesannya adalah 'Email Belum diisi'.
//jika email yang diinput sudah dipakai user lain, maka pesannya 'Email Sudah dipakai'.
...
//membuat rule untuk inputan password agar tidak boleh kosong, tidak ada spasi, tidak boleh kurang dari 3 digit, dan password harus sama dengan repeat password dengan membuat pesan error dengan bahasa sendiri yaitu 

//jika password dan repeat password tidak diinput sama, maka pesannya 'Password Tidak Sama'. 
